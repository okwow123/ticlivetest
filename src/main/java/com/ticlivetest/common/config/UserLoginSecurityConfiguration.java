package com.ticlivetest.common.config;

import com.ticlivetest.common.handler.AuthFailureHandler;
import com.ticlivetest.common.handler.AuthSucessHandler;
import com.ticlivetest.service.MemberService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		*/
        ...
        http.csrf().disable()	// csrf 토큰을 비활성화
                ...
                .antMatchers("/","/login/**","/js/**","/css/**","/robots.txt","/image/**","/img/**","/scss/**", "/api/**","/kakaoapi/**","/test/**","/search/**").permitAll() // 해당 경로들은 접근을 허용
