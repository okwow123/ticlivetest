...
(function (factory) {
    ...
    $h = {
        ...
        defaultButtonCss: function (fill) {
            return 'btn-default btn-' + (fill ? '' : 'outline-') + 'brd-bg-grey';
        },
        now: function () {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '',
        browseClass: 'btn btn-brd-black btn-ocr',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: '<span class="sr-only">찾아보기</span>',
        removeLabel: '삭제',
        removeTitle: '',
        cancelLabel: '취',
        ...
        msgPaused: 'Paused',
        msgPlaceholder: '명함 이미지를 업로드해주세요.',
        ...
        dropZoneTitle: '명함 이미지를 이곳에 놓아 주세요.',
